<div class="mb-8">
    ...
    @if(isset($metasCompletadas) && $metasCompletadas->count() > 0)
            ...
            @foreach ($metasCompletadas as $meta)
                <div class="rounded-2xl border border-[#1f4d35] bg-[#1b1b1d] p-4 shadow-[0_0_20px_rgba(33,120,73,0.35)]">
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <span class="inline-flex items-center rounded-full border border-green-400/20 bg-green-500/10 px-3 py-1 text-xs font-medium text-[#72f59a]">
                            Completada
                        </span>
                    </div>
