<x-app-layout>
    <div class="min-h-screen bg-[#060b08] px-3 py-4 text-white md:px-4 lg:px-5">
        <div
            class="w-full rounded-[24px] border border-[#26352d] bg-[#171c19] shadow-[0_0_18px_rgba(114,245,154,0.05)]">
            <div class="px-4 py-4 md:px-5 lg:px-6 lg:py-5">
                ...
                <div class="mb-4 grid grid-cols-1 gap-4 md:grid-cols-3">
                    <div
                        class="rounded-2xl border border-[#26352d] bg-[#171c19] p-4 shadow-[0_0_18px_rgba(114,245,154,0.06)]">
                        <div class="flex items-center justify-between">
                            ...
                            <div
                                class="flex h-8 w-8 items-center justify-center rounded-lg bg-[#72f59a]/15 text-[#72f59a]">
                                ↑
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        class="rounded-2xl border border-[#26352d] bg-[#171c19] p-4 shadow-[0_0_18px_rgba(255,80,80,0.05)]">
                        <div class="flex items-center justify-between">
                            <div>
                ...
                <!-- FILTROS -->
                <div
                    class="mb-4 rounded-2xl border border-[#26352d] bg-[#171c19] p-4 shadow-[0_0_18px_rgba(114,245,154,0.04)]">
                    <form method="GET" action="{{ route('transacciones.index') }}" id="filtroForm">
                        <div class="flex flex-col gap-3 md:flex-row">
                            ...
                            <select name="tipo" onchange="document.getElementById('filtroForm').submit()"
                                ...
                                <option value="ingreso" {{ request('tipo') == 'ingreso' ? 'selected' : '' }}>Ingresos
                                </option>
                ...
                <div class="space-y-4">
                    ...
                    <div
                        class="rounded-[26px] border border-[#244332] bg-[#1c1f1d] px-6 py-6 shadow-[0_0_30px_rgba(49,196,120,0.16)]">
                        <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                            <!-- IZQUIERDA -->
                            <div class="flex min-w-0 items-center gap-6">
                                <div
                                    class="flex h-[74px] w-[74px] items-center justify-center rounded-full border {{ $colorIcono }} text-[38px]">
                                    {{ $simbolo }}
                                </div>
                                ...
                                <div class="min-w-0">
                                    ...
                                    <div class="mt-4 flex flex-wrap items-center gap-4">
                                        <span
                                            class="inline-flex items-center gap-2 rounded-full px-5 py-2 text-[18px] leading-none"
                                            style="border: 1px solid {{ $categoria->color_hex ?? '#72f59a' }}; background-color: {{ $categoria->color_hex ?? '#72f59a' }}20; color: {{ $categoria->color_hex ?? '#72f59a' }}">
                                            @if($categoria?->icono)
                    ...
                    @empty
                    <div
                        class="rounded-[26px] border border-[#244332] bg-[#1c1f1d] px-6 py-10 text-center shadow-[0_0_30px_rgba(49,196,120,0.10)]">
