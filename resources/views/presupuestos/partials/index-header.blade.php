...
<div class="mb-6 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
    ...
    <div class="flex flex-wrap items-center gap-3">
        @if($presupuestoActual)
        <div
            class="inline-flex items-center gap-3 self-start rounded-full border border-[#2d6f4f] bg-[#1f3a2c] px-4 py-2 text-sm">
            <span class="text-gray-300">Ingreso</span>
        ...
        <a href="{{ route('presupuestos.create') }}" class="budget-btn-primary inline-flex items-center gap-2">
